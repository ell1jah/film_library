...
// @Tags actors
// @Produce json
// @Param input body models.Actor true "Actor object to be added (ignore actor_id and films)"
...
// @Param input body models.Actor true "Actor object with updated information (ignore actor_id and films)"
