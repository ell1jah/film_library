...
// @Tags films
// @Produce json
// @Param input body models.Film true "Film object to be added (ignore film_id)"
...
// @Param input body models.Film true "Film object with updated information (ignore film_id)"
