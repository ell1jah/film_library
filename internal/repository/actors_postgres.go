...
func (a *ActorsPostgres) InsertActor(actor *models.Actor) (int, error) {
	var id int
	dateOfBirth, err := utils.StringToDate(actor.DateOfBirth)
	if err != nil {
		return 0, err
	}
...
func (a *ActorsPostgres) GetActors() (*[]models.Actor, error) {
